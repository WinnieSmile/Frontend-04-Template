/*
 * @Author: your name
 * @Date: 2020-10-27 22:21:12
 * @LastEditTime: 2020-10-27 23:36:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \Frontend-04-Template\Week_09\CSS总论-收集标准\css-crawler.js
 */
// 将标准存在变量 standards 中
var standards = [
  {
...
/*
爬虫编写思路：首先创建一个iframe，然后把页面内容替换成 iframe，然后我们去循环所有的标准，把标准的url放到 src 上，然后就去等待它的 iframe 的load事件。

happen 事件：等待事件发生一次，监听一下事件，如果事件发生了就resolve，resolve之后再把这个事件给它解绑了。
